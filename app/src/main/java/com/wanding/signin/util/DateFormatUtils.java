...
public class DateFormatUtils {
	 ...
	 */
	public static final FastDateFormat ISO_DATETIME_FORMAT1 = FastDateFormat
			.getInstance("yyyy-MM-dd HH:mm:ss");
	public static final FastDateFormat ISO_DATETIME_FORMAT = FastDateFormat
			.getInstance("yyyy-MM-dd'T'HH:mm:ss");
	public static final FastDateFormat ISO_DATETIME = FastDateFormat
			.getInstance("yyyyMMddHHmmssSSS");
	public static final FastDateFormat ISO_DATETIME_SS = FastDateFormat
			.getInstance("yyyyMMddHHmmss");
	public static final FastDateFormat ISO_DATETIME_HH = FastDateFormat
	...
	public static final FastDateFormat ISO_DATE_FORMAT_IMAGE = FastDateFormat
