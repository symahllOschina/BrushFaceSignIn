package com.wanding.signin.httputil;
...
public class HttpURLConnectionUtil {
	 ...
	 * 传入一个Url地址  参数为字符串
	 */
	public static String doPos(String path,String content,String content_type) throws Exception{
		String jsonResult = "";
        ...
        if(CONTENT_TYPE_JSON.equals(content_type)){
        connection.setRequestProperty("Content-Type", CONTENT_TYPE_JSON);
		}else if(CONTENT_TYPE_STR.equals(content_type)){
